...
* console frameworks
    ...
    * one other fun/interesting/challenging one
...
* functions
    * logging lexical context
    * args, local, free (just say no)
    * declare, pass, call
    * trace-log
    * expanding
    * refactor to higher order function exercise
* debugging
